							...
							<tr style="font-size: medium;">
								...
								<td>
									<div class="btn-group-vertical btn-group-sm">
										<a class="btn btn-outline-primary" href="index.php?page=product_view&product_id=<?= $product_id ?>">VIEW</a>
										<a class="btn btn-outline-primary" href="index.php?page=product_edit&product_id=<?= $product_id ?>">EDIT</a>
										<a class="btn btn-outline-danger" href="index.php?page=product_delete&product_id=<?= $product_id ?>" onclick="return confirm('Are you sure to DELETE this PRODUCT?')">DELETE</a>
									</div>
								</td>
							</tr>
						<?php endforeach ?>
